"""
Django settings for noisy_field_39313 project.
...
ROOT_URLCONF = 'noisy_field_39313.urls'
...
WSGI_APPLICATION = 'noisy_field_39313.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_field_39313 API",
    "DESCRIPTION": "API documentation for noisy_field_39313 App",
    "VERSION": "v1",
}
